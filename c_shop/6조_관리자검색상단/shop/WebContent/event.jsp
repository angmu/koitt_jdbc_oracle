  ...
  <section>
    ...
    <article id="event_list">
      ...
      <c:forEach var="dto" items="${list }">
        <li>
         <a href="econtent.event?fnum=${dto.fnum }"><img src="upload/${dto.ffile1 }" alt="" class="event-img"></a>
         <a href="econtent.event?fnum=${dto.fnum }"><div class="event-now">${dto.ftitle }</div></a>
         <div class="event-title">${dto.fcontent }</div>
         <div class="event-title">${dto.fuser }</div>
         <div class="event-date">${dto.fdate1 } ~ ${dto.fdate2 }</div>
        </li>
        </c:forEach>
        </ul>
    </article>
    ...
    <div class="write"><a href="ewrite_view.event">쓰기</a></div>
