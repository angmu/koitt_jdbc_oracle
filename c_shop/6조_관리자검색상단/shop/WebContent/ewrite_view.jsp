...
<body>
  ...
  <section>
    ...
    <form action="eventwrite.event" name="eventwrite" method="post" enctype="multipart/form-data">
      <table>
        <colgroup>
          <col width="15%">
          <col width="85%">
        ...
        <tr>
          <th>내용</th>
          <td>
            <textarea name="fcontent" cols="50" rows="10"></textarea>
          </td>
        </tr>
        <tr>
          <th>메인이미지</th>
      ...
      <div class="button-wrapper">
        <button type="submit" class="write" style="cursor:pointer">작성완료</button>
