...
<body>
  ...
  <section>
    ...
    <table>
      <tr>
        <th>${econtent.ftitle }</th>
      </tr>
      <tr>
        <td>${econtent.fdate1 } ~ ${econtent.fdate2 }</td>
      </tr>
      <tr>
        <td class="article">
          <img src="upload/${econtent.ffile1 }" alt="" width="80%">
          <img src="upload/${econtent.ffile2 }" alt="" >
          </td>
      </tr>
      <tr>
    ...
    <a href="event.event"><div class="list">목록</div></a>
   <a href="edelete.event?fnum=${econtent.fnum }"><div class="list">삭제</div></a> 
   <a href="emodify_view.event?fnum=${econtent.fnum }"><div class="list">수정</div></a> 
  </section>
