	...
	<header>
        ...
        <article id="art_table">
            <table border-top="3">
                ...
                <tr>
                    <td>22</td>
                    <td><a href="notice_view21.html">미리보는 쿡킷 전체메뉴(3월)</a></td>
                    <td>2020-03-02</td>
                     <td>22</td>
                ...
                <tr>
                    <td>21</td>
                    <td><a href="notice_view22.html">'코로나19'로 인한 새벽배송 지연 안내드립니다.</a></td>
                    <td>2020-02-24</td>
                     <td>22</td>
                ...
                <tr>
                    <td>16</td>
                    <td>CJ제일제당 개인정보처리방침 내용 변경 고지[2020.3.3시행]</td>
                    <td>2020-02-25</td>
                     <td>22</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>3</td>
                    <td>[공지] 사이트점검으로 인한 주문취소 불가 안내드립니다 (8/17~18)</td>
                    <td>2019-08-16</td>
                     <td>22</td>
                </tr>
            </table>
            <div id="pagination">
                <div>
					<button type="button" onclick="location.href='input_page.html'"><span>글쓰기</span></button>
				</div>
                <div>
                    <span>1</span>
                    <span>2</span>
