...
<header id="topfix">
	<div id="header">
		<div class="logo_txt" style="margin: 12px 0 0 16px">
	...
	<div id="wrap">
		<div id="manage_main">
			...
			<div id="contentArea">
				...
				<form action="form_ok.jsp" method="post" name="input_form_ad" enctype="multipart/form-data">
					<table>
						<colgroup>
						<col width="130px">
						<col width="870px">
						...
						<tfoot>
						<tr>
							<th><img src="images/admin_input/t_icon.png" alt="" class="th_con">첨부파일<span><img src="images/admin_input/icon_help.png" alt="이미지 혹은 문서파일만 첨부가능" class="file_ico"></span></th>
							<td class="filebox"><input type="file" name="bFile1">이벤트등록시 업로드 (가로 380*세로 232)</td>
						</tr>
						<tr>
							<th><img src="images/admin_input/t_icon.png" alt="" class="th_con">첨부파일<span><img src="images/admin_input/icon_help.png" alt="이미지 혹은 문서파일만 첨부가능" class="file_ico"></span></th>
							<td class="filebox"><input type="file" name="bFile2">글내용에 들어갈 파일입니다.</td>
						</tr>
						<tr>
					...
					<div class="btn_area">
						...
						<input type="button" value="리스트" onclick="location.href='admin_board.html'">
					</div>
				</form>
